...
import { Theme, Link, Text, Icon, Box, Section, Input, Button } from "@quarkly/widgets";
import { Helmet } from "react-helmet";
import { GlobalQuarklyPageStyles } from "global-page-styles";
import { RawHtml, Override, Menu, StackItem, Stack, Formspree } from "@quarkly/components";
import * as Components from "components";
import { MdHelp, MdArrowDownward, MdLocationOn, MdEmail, MdPhone } from "react-icons/md";
...
export default (() => {
	return <Theme theme={theme}>
		...
		<Section color="--dark">
			<Override slot="SectionContent" transition="--opacityOut" background="#d3bcbc" />
			...
			>
				...
				<Text as="p" font="--lead" margin="10px 0" color="--greyD2">
					It all beginjs with an idea. Maybe you want to launch a business. Maybe you want to turn a hobby into something more. Or maybe you have a creative project to share with the world. Whatever it is, the way you tell your story online can make all the difference.
				</Text>
			</Box>
			<Box
				margin="36px 0 0 0"
		...
		<RawHtml>
			<style place={"endOfHead"} rawKey={"60e1d1b4a4e264001e653637"}>
